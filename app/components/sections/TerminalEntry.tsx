  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        {/* --- NEW WARNING SECTION --- */}
        <div className="flex items-center gap-4 mb-4 px-2 py-2 border-l-2 border-yellow-500/50 bg-yellow-500/5">
           <div className="w-2 h-2 rounded-full bg-yellow-500 animate-pulse" />
           <p className="text-[9px] md:text-[10px] text-yellow-500/80 tracking-[0.2em] uppercase leading-none">
             Warning: Optimization detected. Best experienced on Desktop/Laptop devices.
           </p>
        </div>

        {/* Header Section (Terminal) */}
        ...
        {!booting ? (
          ...
          <div className="w-full flex flex-col items-center gap-3">
             ...
             <p className="text-[#00ff41] text-[10px] animate-pulse uppercase tracking-widest">Booting_Core_Modules...</p>
          </div>
        )}
